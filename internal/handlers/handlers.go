...
import (
	...
	"log"
	"net/http"
	"pdev-finmart/internal/config"
	"pdev-finmart/internal/driver"
	"pdev-finmart/internal/forms"
	"pdev-finmart/internal/helpers"
	"pdev-finmart/internal/models"
	"pdev-finmart/internal/render"
	"pdev-finmart/internal/repository"
	"pdev-finmart/internal/repository/dbrepo"
	"strconv"
	"strings"
	"time"
)
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	Dear %s: <br>
	This is your confirmation reservation from %s to %s.
`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))

	msg := models.MailData{
		To:       reservation.Email,
		From:     "memew@admin.com",
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	reservation, ok := m.App.Session.Get(r.Context(), "reservations").(models.Reservation)
	if !ok {
...
// BookRoom take URL parameters, build a sessional variable, and take user to make res screen
...
//ShowRegister show the register screen
